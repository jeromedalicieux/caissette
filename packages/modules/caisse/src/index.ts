...
import type { Cents, Hash, ItemId, PaymentMethod, SaleId, ShopId, UserId } from '@caissette/types'
import { computeChainedHash, generateUuidV7 } from '@caissette/utils'
import { calculateVatMargin, type VatMarginInput } from '@caissette/tva-marge'
